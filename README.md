...
| [#169](../../pull/169) | **Issue #62: サンプルデータ除去・実案件データ運用化**（案件詳細の API 実データ化・本番モードのサンプル非表示化・API クライアント拡張） | ✅ CI 全チェック pass（2026-08-10・Browser E2E 含む）→ マージ判定 Y/N |
